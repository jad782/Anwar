...
2. عدّل **Bundle Identifier** ليطابق `com.alanwar.quran.jad` (أو معرّفك).
...
- يستخدم `cordova-plugin-purchase`. أنشئ في **App Store Connect** منتجات **Consumable** بالمعرّفات:
  - `com.alanwar.quran.jad.tip1` (0.99$)
  - `com.alanwar.quran.jad.tip5` (4.99$)
  - `com.alanwar.quran.jad.tip10` (9.99$)
