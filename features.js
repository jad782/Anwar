...
const ATHKAR_LIB = {
  athkar: { name:'الأذكار', en:'Athkar', cats:{
    morning:{ ar:'أذكار الصباح', en:'Morning', items:[
      {text:'اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ... (آية الكرسي)', info:'من قالها حين يصبح أُجير من الجن حتى يمسي.', max:1, src:'النسائي وصححه الألباني'},
      ...
      {text:'سَيِّدُ الِاسْتِغْفَارِ: اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ...', info:'من قالها موقناً بها فمات من يومه دخل الجنة.', max:1, src:'البخاري'},
    ...
    wake:{ ar:'أذكار الاستيقاظ', en:'Waking', items:[
      ...
      {text:'لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ اللَّهُمَّ أَسْتَغْفِرُكَ لِذَنْبِي...', info:'', max:1, src:'النسائي'},
    ]},
  ...
  duaa: { name:'الأدعية', en:"Du'a", cats:{
    istikhara:{ ar:'دعاء الاستخارة', en:'Istikharah', items:[
      {text:'اللَّهُمَّ إِنِّي أَسْتَخِيرُكَ بِعِلْمِكَ، وَأَسْتَقْدِرُكَ بِقُدْرَتِكَ، وَأَسْأَلُكَ مِنْ فَضْلِكَ الْعَظِيمِ...', info:'يصلي ركعتين من غير الفريضة ثم يدعو.', max:1, src:'البخاري'},
    ]},
    ...
    wind:{ ar:'دعاء الريح', en:'Wind', items:[
      {text:'اللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَهَا وَخَيْرَ مَا فِيهَا وَخَيْرَ مَا أُرْسِلَتْ بِهِ، وَأَعُوذُ بِكَ مِنْ شَرِّهَا...', info:'', max:1, src:'مسلم'},
    ]},
    ...
    hilal:{ ar:'دعاء رؤية الهلال', en:'New moon', items:[
      {text:'اللَّهُمَّ أَهِلَّهُ عَلَيْنَا بِالْأَمْنِ وَالْإِيمَانِ، وَالسَّلَامَةِ وَالْإِسْلَامِ... رَبِّي وَرَبُّكَ اللَّهُ', info:'', max:1, src:'الترمذي'},
    ]},
    witr:{ ar:'دعاء القنوت', en:'Witr Qunut', items:[
      {text:'اللَّهُمَّ اهْدِنِي فِيمَنْ هَدَيْتَ، وَعَافِنِي فِيمَنْ عَافَيْتَ، وَتَوَلَّنِي فِيمَنْ تَوَلَّيْتَ...', info:'في وتر الصلاة.', max:1, src:'أبو داود والترمذي'},
    ]},
  }},
  fadail: { name:'الفضائل', en:'Virtues', cats:{
    ...
    tasbeeh:{ ar:'فضل التسبيح والتحميد', en:'Tasbeeh', items:[
      ...
      {text:'من قال: لا إله إلا الله وحده لا شريك له... مئة مرة، كانت له عدل عشر رقاب.', info:'', max:1, src:'متفق عليه'},
    ]},
